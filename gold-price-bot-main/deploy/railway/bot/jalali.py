# تبدیل تاریخ میلادی ↔ جلالی بدون کتابخانه‌ی خارجی
# الگوریتم استاندارد (نسخه‌ی jdf.scr.ir) — تست‌شده روی تاریخ‌های معلوم
...
# weekday(): دوشنبه=0 ... یکشنبه=6
J_WEEKDAYS = ["دوشنبه", "سه‌شنبه", "چهارشنبه", "پنجشنبه", "جمعه", "شنبه", "یکشنبه"]
...
def format_jalali_datetime(dt, with_weekday: bool = True) -> str:
    """datetime (ترجیحاً به وقت تهران) → «سه‌شنبه ۳ شهریور ۱۴۰۵ • ۲۰:۰۴»"""
    from .persian import fa_digits  # import داخلی برای پرهیز از چرخه
